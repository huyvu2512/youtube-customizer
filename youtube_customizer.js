...
(() => {
  ...
  function showSeekOsd(player, delta) {
    ...
    const iconSvg = isFwd ? `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M4 18l8.5-6L4 6v12zm9-12v12l8.5-6L13 6z"/></svg>` : `<svg viewBox="0 0 24 24" fill="currentColor"><path d="M11 18V6l-8.5 6 8.5 6zm9-12v12l-8.5-6 8.5-6z"/></svg>`;
    ...
    if (!panel) {
      ...
      panel.innerHTML = safeHTML(`
            <div class="ytc-header">
                ...
                <span class="ytc-header-badge">v2.9.7</span>
            </div>
