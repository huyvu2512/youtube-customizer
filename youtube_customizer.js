...
(() => {
  ...
  function autoCollapseNativeChatIfOpen() {
    ...
    const closeBtn = document.querySelector(
      '#panels-full-bleed-container #visibility-button button, #panels-full-bleed-container #close-button button, #panels-full-bleed-container [aria-label*="Đóng" i], #panels-full-bleed-container [aria-label*="Close" i], ytd-engagement-panel-section-list-renderer[target-id*="chat" i] #visibility-button button, ytd-engagement-panel-section-list-renderer[target-id*="chat" i] #close-button button, ytd-engagement-panel-section-list-renderer[target-id*="chat" i] [aria-label*="Đóng" i], ytd-engagement-panel-section-list-renderer[target-id*="chat" i] [aria-label*="Close" i], ytd-live-chat-frame#chat #show-hide-button button, #chat.ytd-watch-flexy #show-hide-button button, ytd-live-chat-frame #close-button button, ytd-live-chat-frame #close-button, #show-hide-button button, [aria-label*="Ẩn cuộc trò chuyện" i], [aria-label*="Hide chat" i]'
    );
    if (closeBtn) {
  ...
  var userManuallyOpenedChat, hasAutoCollapsedChatForCurrentVideo, chatToggleListenersBound, ensureNativeLiveChatRunning, bgChatIframe, currentBgVideoId, UNICODE_EMOJI_REGEX2;
